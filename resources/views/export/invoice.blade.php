        ...
        <table class="w-full text-base font-semibold text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        {{ money($orderProduct->unit_price, 'myr, true) }}
                    </td>
                    <td class="px-6 py-4">
                        {{ money($orderProduct->sale_price, 'myr, true) }}
                    </td>
                </tr>
                @endforeach
            </tbody>
            ...
            <div class="w-1/2 border border-gray-200 rounded-md p-4">
                ...
                <div class="flex flex-col gap-2">
                    <div class="w-full flex justify-between">
                        ...
                        <p class="font-semibold">
                            {{ money($invoice->order->total_price, 'myr, true) }}
                        </p>
                    </div>
                    <hr class="w-full bg-gray-600 my-2">
                    <div class="w-full flex justify-between">
                    ...
                    <div class="w-full flex justify-between">
                        ...
                        <p class="font-semibold">
                            {{ money($invoice->order->total_price * 1.19, 'myr, true) }}
                        </p>
                    </div>
                </div>
            </div>
